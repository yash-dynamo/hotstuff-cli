...
export class WebSocketTransport {
    ...
    handleJSONRPCResponse(response) {
        const responseId = response.id === null || response.id === undefined ? null : String(response.id);
    ...
    async request(type, payload, signal) {
        ...
        const requestPromise = this.sendJSONRPCMessage(message);
        if (!signal) {
        ...
        return new Promise((resolve, reject) => {
            ...
            requestPromise
                ...
                resolve(this.normalizeRequestResult(result));
            })
                .catch((error) => {
                signal.removeEventListener('abort', onAbort);
                reject(error);
